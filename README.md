...
helm install --set ingress.enabled=true --set ingress.hosts.cms=cms.my-page.domain --set ingress.hosts.site=my-page.domain my-websight websight/websight-cms -n ws --create-namespace
```
